      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-7">
            <div className="flex items-center gap-2 mb-3">
              <span className="text-[11px] font-mono tracking-[0.25em] uppercase text-[#C95D39] dark:text-[#E06A42] font-semibold">
                SCENE 08 · PERSPECTIVE
              </span>
              <span className="h-px w-6 bg-[#C95D39]/30" />
            </div>
            <h2 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-[#171512] dark:text-[#F4EEE4] leading-[0.98]">
              India is bigger <br />
              <span className="text-[#174D47] dark:text-[#E0B36E]">than a bucket list.</span>
            </h2>
            <p className="text-base sm:text-lg text-[#756E64] dark:text-[#B3AA9E] max-w-lg font-normal leading-relaxed mt-4">
              Some places are worth visiting. Others are worth getting lost in.
            </p>
          </div>

          {/* Simple Indian Humour Cards (#32) */}
          <div className="lg:col-span-5 space-y-3 pt-2">
            <VariantGlass
              intensity="medium"
              className="rounded-2xl p-4 border-black/5 dark:border-white/10"
            >
              <div className="flex items-center gap-3 text-xs sm:text-sm font-mono text-[#171512] dark:text-[#F4EEE4]">
                <span className="w-2 h-2 rounded-full bg-[#C95D39] shrink-0" />
            ...
            >
              <div className="flex items-center gap-3 text-xs sm:text-sm font-mono text-[#171512] dark:text-[#F4EEE4]">
                <MessageCircle className="w-4 h-4 text-[#174D47] dark:text-[#E0B36E] shrink-0" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white dark:bg-[#171512] rounded-3xl p-6 sm:p-10 lg:p-12 shadow-[0_24px_70px_rgba(23,21,18,0.08)] dark:shadow-[0_24px_70px_rgba(0,0,0,0.6)] border border-black/5 dark:border-white/10">
          ...
          <div className="lg:col-span-5 space-y-4">
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-2xl transition-all duration-300 flex items-center justify-between ${
                      isActive
                        ? 'bg-[#174D47] text-white dark:bg-[#1D5B54] shadow-md'
                        : 'text-[#171512] dark:text-[#F4EEE4] hover:bg-black/5 dark:hover:bg-white/5'
                    }`}
                  >
                    <div>
                      <span className={`text-[10px] font-mono uppercase tracking-widest block ${
                        isActive ? 'text-[#E0B36E]' : 'text-[#756E64] dark:text-[#B3AA9E]'
                      }`}>
                        {persp.tag}
                      </span>
                    ...
                    <span className={`text-xs font-mono ${isActive ? 'text-white' : 'text-[#756E64]'}`}>
                      0{idx + 1}
                    </span>
                  </button>
                );
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="p-4 rounded-2xl bg-[#F3EFE6] dark:bg-[#0D0C0A] border border-black/5 dark:border-white/10 text-xs sm:text-sm text-[#171512]/80 dark:text-[#F4EEE4]/80 leading-relaxed font-normal"
              >
                {activePersp.text}
              </motion.div>
            </AnimatePresence>
          ...
          <div className="lg:col-span-7 relative">
            <div className="relative aspect-[16/10] sm:aspect-[16/11] rounded-2xl overflow-hidden shadow-2xl bg-[#E8DED0] dark:bg-[#25221E] border-4 border-[#F3EFE6] dark:border-[#0D0C0A]">
              <AnimatePresence mode="wait">
                <motion.div
                  key={activePersp.id}
