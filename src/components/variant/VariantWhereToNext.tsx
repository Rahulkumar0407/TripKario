  ...
  return (
    <section className="py-24 sm:py-32 px-4 sm:px-6 lg:px-12 relative overflow-hidden bg-[#F3EFE6] dark:bg-[#0D0C0A] transition-colors duration-500">
      <div className="max-w-7xl mx-auto text-center">
        ...
        {/* The Gathering Final Pinboard Layout (#26 & #27) */}
        <div className="relative max-w-5xl mx-auto rounded-3xl bg-[#E8DED0]/60 dark:bg-[#171512] p-6 sm:p-10 border-4 sm:border-8 border-white dark:border-[#1F1C18] shadow-[0_24px_80px_rgba(23,21,18,0.1)] dark:shadow-[0_24px_80px_rgba(0,0,0,0.6)] mb-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            ...
            className="px-10 py-5 rounded-full bg-[#C95D39] hover:bg-[#B34F2D] text-white font-bold text-sm tracking-widest uppercase flex items-center justify-center gap-3 shadow-[0_12px_36px_rgba(201,93,57,0.4)] hover:shadow-[0_16px_44px_rgba(201,93,57,0.55)] transition-all duration-300 group"
          >
