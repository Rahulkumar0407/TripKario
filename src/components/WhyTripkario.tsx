...
export default function WhyTripkario() {
  ...
  return (
    <section id="why-us" className="py-14 sm:py-20 md:py-32 bg-[var(--bg-primary)] text-[var(--text-primary)] border-t border-[var(--border-subtle)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 space-y-4 sm:space-y-6">
            ...
            <h2 className="text-3xl sm:text-5xl lg:text-6xl font-serif font-normal leading-[1.08] text-[var(--text-primary)] tracking-tight">
            ...
            <p className="text-sm sm:text-base text-[var(--text-muted)] leading-relaxed max-w-md font-normal">
          ...
          <div className="lg:col-span-6 space-y-3 sm:space-y-4">
            {pillars.map((p) => (
              <div
                key={p.num}
                className="p-4 sm:p-6 rounded-3xl bg-[var(--bg-surface)] border border-[var(--border-card)] shadow-xs flex items-start gap-3.5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-[var(--accent)]/30"
              >
                <span className="text-xs sm:text-sm font-mono font-bold text-[var(--accent)] mt-0.5 shrink-0">
                  {p.num}
                </span>
            ...
            <div className="p-3.5 sm:p-4 rounded-2xl bg-[var(--bg-surface-2)] text-xs font-mono text-[var(--text-muted)] flex items-center justify-between">
